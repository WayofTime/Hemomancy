...
public class HarvestProjectileEffect implements IOnProjectileCollideEffect
{
	...
	{
		return this.harvestPlantsAtPoint(projectile, shooter, pos.getX(), pos.getY(), pos.getZ(), potency);
	}
	...
	{
		return this.harvestPlantsAtPoint(projectile, shooter, pos.getX(), pos.getY(), pos.getZ(), potency / 2.0f);
	}
